CREATE TABLE [dbo].[MI_REPORTING_STAGING_HealthAndSafety_CC] (
    ...
    CONSTRAINT [MI_ID2_pk] PRIMARY KEY CLUSTERED ([MI_ID] ASC)
);


GO
GRANT ALTER
    ON OBJECT::[dbo].[MI_REPORTING_STAGING_HealthAndSafety_CC] TO [db_truncator]
    AS [dbo];
